...
public interface MaterialMenu {
    ...
    /**
     * Manually set a transformation value for an {@link com.huagu.RX.rongxinmedical.widget.materialmenuview.MaterialMenuDrawable.AnimationState}
     *
     * @param animationState state to set value in
     * @param value          between {@link com.huagu.RX.rongxinmedical.widget.materialmenuview.MaterialMenuDrawable#TRANSFORMATION_START} and
     *                       {@link com.huagu.RX.rongxinmedical.widget.materialmenuview.MaterialMenuDrawable#TRANSFORMATION_END}.
     */
